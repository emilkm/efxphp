...
class InputTest extends \PHPUnit_Framework_TestCase
{
     ...
     *
     */
    public function testreadAmf3ObjectTypedFromField()
    {
        $exp = new \emilkm\tests\asset\value\VoExplicitTypeNotBlank();
     ...
     *
     */
    public function testreadAmf3TypedFromFieldAndTraitsReference()
    {
        $remoteClassField = Constants::REMOTE_CLASS_FIELD;
        $v1 = new stdClass();
     ...
     *
     */
    public function testreadAmf3ObjectTypedFromFieldAndTraitsReferenceMissingProperty()
    {
        $remoteClassField = Constants::REMOTE_CLASS_FIELD;
        $v1 = new stdClass();
        $v1->$remoteClassField = 'LightClass';
