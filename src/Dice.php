...
class Dice
{
    ...
    /**
     * Optionaly save the Dice instance to the 'shared' store.
     *
     * @param mixed $shareme
     */
    ...
    {
        if ($shareme) {
            $this->instances['emilkm\\efxphp\\Dice'] = $this;
        }
    }

    /**
     * Add an instance of an object to the Dice 'shared' store.
     *
     * @param mixed $name
    ...
    /**
     * Get an instance from the Dice 'shared' store.
     *
     * @param mixed $name
     *
     * @return mixed
    ...
    public function getRule($name)
    {
        ...
        // next, look for a rule which matches the class described in $name where:
